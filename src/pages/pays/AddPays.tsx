// src/pages/pays/page.tsximport React, { useState, useRef } from 'react';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!name.trim()) {
            ...
            toast.current?.show({
                severity: 'error',
                summary: 'Erreur',
                detail: 'Le nom du pays ne peut pas être vide.',
                // life: 3000,
            });
            return;
        }
        ...
        try {
            ...
            toast.current?.show({
                severity: 'success',
                summary: 'Succès',
                detail: `Pays "${response.data.data.name}" ajouté avec succès.`,
                life: 3000,
            });
            setName('');
        } catch (err: any) {
